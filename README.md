...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://RomanHasiuk.github.io/react_dynamic-list-of-posts/) and add it to the PR description.