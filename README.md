...
> Here is [the working version](https://KOliinyk/react_dynamic-list-of-posts/)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://KOliinyk.github.io/react_dynamic-list-of-posts/) and add it to the PR description.
