...
const page = {
  ...
  noselUserMessage: () => cy.byDataCy('NoselUser'),
...
const userSelector = {
  ...
  selUser: () => userSelector.el().find('a.dropdown-item.is-active'),
...
const newCommentForm = {
  ...
  assertBodyError: hasError => {
    if (hasError) {
      newCommentForm.bodyerrMsg().should('exist');
      newCommentForm.bodyArea().should('have.class', 'is-danger');
    } else {
      newCommentForm.bodyerrMsg().should('not.exist');
...
describe('', () => {
  ...
  describe('Page by default', () => {
    describe('', () => {
      ...
      it('should show NoselUser message', () => {
        page.noselUserMessage().should('exist');
      });
  ...
  describe('UserSelector', () => {
    const { el, button, users, selUser } = userSelector;
