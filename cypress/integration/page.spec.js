...
describe('', () => {
  ...
  describe('Page by default', () => {
    describe('', () => {
      ...
      it.skip('should show NoSelectedUser message', () => {
        page.noSelectedUserMessage().should('exist');
      });

      it.skip('should not show posts', () => {
        page.postsList().should('not.exist');
        page.posts().should('not.exist');
      });

      it.skip('should not show posts error message', () => {
        page.postsLoadingError().should('not.exist');
      });

      it.skip('should not show no posts yet message', () => {
        page.noPostsYetMessage().should('not.exist');
      });

      it.skip('should not show posts loader', () => {
        page.postsLoader().should('not.exist');
      });
    });

    describe('', () => {
      it.skip('should request users from API', () => {
  ...
  describe('Posts List', () => {
    ...
    describe('after selecting one', () => {
      ...
      it.skip('should remove `is-light` class from the selected post button', () => {
        page.postButton(0).should('not.have.class', 'is-light');
      });

      it.skip('should change selected button text to Close', () => {
        page.posts().eq(0).byDataCy('PostButton').should('have.text', 'Close');
      });

      it.skip('should keep all posts visible', () => {
        page.posts().should('have.length', 10);
        page.posts().eq(0).byDataCy('PostId').should('have.text', '1');
        page.posts().eq(9).byDataCy('PostId').should('have.text', '10');
      });

      it.skip('should have only one selected post', () => {
        page.assertSelectedPostsCount(1);
      });

      it.skip('should have not selected posts after clicking Close', () => {
        page.postButton(0).click();

        page.assertSelectedPostsCount(0);
      });

      it.skip('should have only the last post selected after selecting another one', () => {
      ...
      it.skip('should not have selected posts after user change', () => {
        page.mockUser2Posts();
        userSelector.select(1);
  ...
  describe('PostDetails', () => {
    ...
    describe('after comments are loaded', () => {
      ...
      it.skip('should hide WriteCommentButton after clicking it.skip', () => {
  ...
  describe('NewCommentForm', () => {
    ...
    it.skip('should show all errors after submitting an empty form', () => {
      newCommentForm.submitButton().click();
    ...
    it.skip('should clear the form with reset button', () => {
      newCommentForm.nameInput().type('Some name');
      newCommentForm.emailInput().type('some@email.com');
      newCommentForm.bodyArea().type('Some comment body');
    ...
    it.skip('should not send request is name is empty', () => {
    ...
    it.skip('should not send request if email is empty', () => {
      page.spyOnCommentsPost();
    ...
    it.skip('should not send request if body is empty', () => {
      page.spyOnCommentsPost();
    ...
    it.skip('should send form data to the API if form is valid', () => {
      page.spyOnCommentsPost();
    ...
    it.skip('should hide submit button spinner after success', () => {
      page.spyOnCommentsPost();
    ...
    it.skip('should clear body after submitting', () => {
      page.spyOnCommentsPost();
