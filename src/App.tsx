...
export const App = () => {
  ...
  // const isPostsListExists = activeUser && !isError && posts.length > 0; // ? posts : false;
      ...
      <div className="container">
        <div className="tile is-ancestor">
            ...
            <div className="tile is-child box is-success">
              ...
              <div className="block" data-cy="MainContent">
                ...
                {!isLoading && posts.length > 0 && (
                  <PostsList
                    // isPostsListExists={isPostsListExists}
                    posts={posts}
          ...
          {/* {activePost && (
            <div
              data-cy="Sidebar"
              className="tileis-parent is-8-desktop Sidebar Sidebar--open"
            >
              <div className="tile is-child box is-success ">
                <PostDetails activePost={activePost} />
              </div>
