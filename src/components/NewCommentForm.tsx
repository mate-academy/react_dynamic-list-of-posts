...
interface Props {
  postId: number;
  setComments: React.Dispatch<SetStateAction<Comment[] | null>>;
...
export const NewCommentForm: React.FC<Props> = ({
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const comment = await clientApi.postComment(newComment);

      setComments(cur => (cur ? [...cur, comment] : [comment]));
    } catch {
      setIsError(true);
      ...
      <div className="field" data-cy="BodyField">
        ...
        <div className="control">
          <textarea
            ...
            className={cn('textarea', { 'is-danger': bodyInvalid })}
            value={body}
            onChange={event => {
