...
import { addComment, getComments, removeComments } from '../../api/comments';
...
export const PostDetails = ({ postId }) => {
  ...
  const loadPostComments = useCallback(async() => {
    ...
    const loadedPostComments = await getComments(postId);
  ...
  const addNewComment = async(name, email, body) => {
    setLoadingComment(true);
